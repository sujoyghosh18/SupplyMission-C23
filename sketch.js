...
function setup() {
	...
	boxPos = width/2-100;
	boxY = 610;
	leftwall = createSprite(boxPos,boxY,20,100);
	leftwall.shapeColor = "red";
	leftwallbody = Bodies.rectangle(boxPos,boxY,20,100,{isStatic:true});
	...
	rightwall = createSprite(boxPos+200,boxY,20,100);
	rightwall.shapeColor = "red";
	rightwallbody = Bodies.rectangle(boxPos+200,boxY,20,100,{isStatic:true});
